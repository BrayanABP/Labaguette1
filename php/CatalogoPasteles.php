                ...
                <div class="popup">
                  <div class="popup-content">
                    ...
                    <div class="product-details">
                      ...
                      <p>esta novedad es una de las tortas mas deliciosas pedidas por los clientes ya sea por su esponjosidad y su gran sabor a nuez y chocolate.</p>
                ...
                <div class="popup">
                  <div class="popup-content">
                    ...
                    <div class="product-details">
                      ...
                      <p>70 g de mantequilla sin sal a temperatura ambiente · 75 g de aceite de canola o vegetal · 740 g de azúcar blanca · 6 huevos · 210 ml de jugo de maracuyá.</p>
                      <p><b>Peso:</b> 150 gramos</p>
                ...
                <div class="popup">
                  <div class="popup-content">
                    ...
                    <div class="product-details">
                      ...
                      <p>Tres sabores fuertes se mezclan para darle al Red Velvet Cake ese gusto particular: la vainilla de base, una insinuación de chocolate y el lustre de queso crema.</p>
                      <p><b>Peso:</b> 150 gramos</p>
                      <p><b>Cantidad disponible:</b> 10</p>
                      <button class="add-to-cart1">Agregar al carrito</button>
                    </div>
                ...
                <div class="popup">
                  <div class="popup-content">
                    ...
                    <div class="product-details">
                      ...
                      <p>cremar mantequilla, azúcar y la ralladura de naranja hasta que observemos que la mantequilla tomó un tono más claro.</p>
                      <p><b>Peso:</b> 150 gramos</p>
                      <p><b>Cantidad disponible:</b> 10</p>
                      <button class="add-to-cart1">Agregar al carrito</button>
                    </div>
                ...
                <div class="popup">
                  <div class="popup-content">
                    ...
                    <div class="product-details">
                      ...
                      <p>Al quedarse compacto, crujiente por fuera y tierno por dentro, el brownie presenta un color marrón oscuro que hace que este nombre le venga como anillo al dedo.</p>
                ...
                <div class="popup">
                  <div class="popup-content">
                    ...
                    <div class="product-details">
                      ...
                      <p>ingredientes para conseguir el sabor y color que mejor complementa al bizcocho preparado. Aquí no puede faltar el chocolate, la fresa, la canela o el limón. En primer lugar, hablamos del frosting.</p>
                      <p><b>Peso:</b> 200 gramos</p>
                      <p><b>Cantidad disponible:</b> 20</p>
                      <button class="add-to-cart1">Agregar al carrito</button>
                    </div>
                ...
                <div class="popup">
                  <div class="popup-content">
                    ...
                    <div class="product-details">
                      ...
                      <p>su propio nombre deleita lo delicioso que es ya que lleva chocolate con frambuesas en la arriba del pastel.</p>
                ...
                <div class="popup">
                  <div class="popup-content">
                    ...
                    <div class="product-details">
                      ...
                      <p>LLa torta de auyama tipo pudín, en esta torta les ofrecemos con pedacitos de queso para más sabor.</p>
                      <p><b>Peso:</b> 150 gramos</p>
                      <p><b>Cantidad disponible:</b> 20</p>
                      <button class="add-to-cart1">Agregar al carrito</button>
                    </div>
                ...
                <div class="popup">
                  <div class="popup-content">
                    ...
                    <div class="product-details">
                      ...
                      <p>Las esponjosas capas de pastel se cubren de un sabroso glaseado de coco y trozos de coco para crear lo que será la torta más codiciada de la temporada.</p>
                      <p><b>Peso:</b> 200 gramos</p>
                      <p><b>Cantidad disponible:</b> 20</p>
                      <button class="add-to-cart1">Agregar al carrito</button>
                    </div>
                ...
                <div class="popup">
                  <div class="popup-content">
                    ...
                    <div class="product-details">
                      ...
                      <p>La tarta dulce consiste en un relleno de mantequilla, azúcar, almíbar y huevo, horneados en una masa de hojaldre hasta que el relleno esté semisólido con una parte superior crujiente.</p>
                      <p><b>Peso:</b> 150 gramos</p>
                      <p><b>Cantidad disponible:</b> 10</p>
                      <button class="add-to-cart1">Agregar al carrito</button>
                    </div>
                ...
                <div class="popup">
                  <div class="popup-content">
                    ...
                    <div class="product-details">
                      ...
                      <p>El Ponqué Ramo Tradicional es la semilla con la que inició la historia de la compañía y el origen de las caras de ponqué de los colombianos.</p>
                ...
                <div class="popup">
                  <div class="popup-content">
                    ...
                    <div class="product-details">
                      ...
                      <p>Este delicioso postre está hecho con zumo natural de limón, crema de leche, galletas caseras y leche condensada.</p>
                      <p><b>Peso:</b> 100 gramos</p>
                      <p><b>Cantidad disponible:</b> 10</p>
                      <button class="add-to-cart1">Agregar al carrito</button>
                    </div>
                ...
                <div class="popup">
                  <div class="popup-content">
                    ...
                    <div class="product-details">
                      ...
                      <p>pastel tradicionalmente redondo compuesto de una o más capas de masa dulce cocida al horno, rellenadas y decoradas con crema pastelera, chocolate, fruta u otros ingredientes..</p>
                ...
                <div class="popup">
                  <div class="popup-content">
                    ...
                    <div class="product-details">
                      ...
                      <p>astel suave y esponjoso que recuerda al algodón y es uno de los postres típicos de los restaurantes y cafeterías japonesas.</p>
                      <p><b>Peso:</b> 150 gramos</p>
                ...
                <div class="popup">
                  <div class="popup-content">
                    ...
                    <div class="product-details">
                      ...
                      <p>pan dulce que se hornea o se fríe. Algunas donas se hacen en forma de aro, mientras que otras se ven más como bollos y están llenas de crema o mermelada.</p>
                      <p><b>Peso:</b> 100 gramos</p>
                      <p><b>Cantidad disponible:</b> 10</p>
                      <button class="add-to-cart1">Agregar al carrito</button>
                    </div>
